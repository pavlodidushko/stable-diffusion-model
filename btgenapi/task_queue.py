...
from btgenapi.file_utils import delete_output_file, get_file_serve_url
from btgenapi.img_utils import narray_to_base64img
from btgenapi.parameters import ImageGenerationParams, ImageGenerationResult, GenerationFinishReason
...
class TaskQueue(object):
    ...
    def finish_task(self, job_id: str):
        ...
        if task is not None:
            ...
            if self.persistent:
                from btgenapi.sql_client import add_history
