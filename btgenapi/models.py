...
from btgenapi.parameters import (GenerationFinishReason,
                                   default_styles,
...
class ImgUpscaleOrVaryRequest(Text2ImgRequest):
    ...
    def as_form(cls, input_image: UploadFile = Form(description="Init image for upsacale or outpaint"),
                ...
                aspect_ratios_selection: str = Form(default_aspect_ratio, description="Aspect Ratios Selection, default 800*1200"),
